...
Add a helper that deterministically maps a user ID to a consistent colour from a fixed palette
...
4. return a session token with:
    - user name
    - avatar
    - generated cursor colour

Return `403` fr unauthorised project access
